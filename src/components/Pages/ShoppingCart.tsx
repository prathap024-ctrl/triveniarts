...
import { useCart } from "../cartutils/CartContext"; // Adjust path as needed
import { Button } from "@/components/ui/button"; // Adjust path based on your shadcn/ui setup

const ShoppingCart: React.FC = () => {
  const { cartItems, updateQuantity, removeItem } = useCart(); // Use the cart context with persistent state
