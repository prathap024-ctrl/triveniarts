            ...
            {cartItems.length > 0 ? (
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="overflow-hidden border-0 shadow-md rounded-none bg-white"
                  >
                    <div className="p-4 flex flex-col sm:flex-row gap-4">
                      <div className="w-full sm:w-32 h-32 bg-gray-200 shrink-0">
                        <img
                          src={item.image}
                          alt={item.name}
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-2">
                          <div className="flex items-center space-x-1 border border-gray-200 rounded-none w-fit">
                            <Button
          ...
          <div className="lg:col-span-1">
            <div className="shadow-md border-0 sticky top-4 rounded-none bg-white">
              <div className="p-6">
                ...
                {showError && (
                  <div className="mb-4 p-3 bg-red-50 border border-red-200 text-red-800 rounded-none">
