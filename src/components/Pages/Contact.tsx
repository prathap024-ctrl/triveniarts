  ...
  return (
    <div className="p-10">
      <div className="abeezee-regular grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-white font-[sans-serif]">
        ...
        <div className="bg-[#521635] rounded-none md:col-span-2 p-8">
          ...
          <form>
            <div className="space-y-4 mt-8">
              <input
                ...
                className="px-2 py-3 bg-transparent text-white font-medium w-full text-sm border-b border-white outline-none"
              />
              <input
                type="text"
                placeholder="Street"
              ...
              <textarea
                ...
                className="px-2 pt-3 bg-transparent text-white font-medium w-full text-sm border-b border-white outline-none"
              ></textarea>
            </div>

            <button
              type="button"
              className="mt-8 flex items-center justify-center text-sm rounded-none px-4 py-2.5 text-[#521635] bg-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
